...
namespace PhysicsEngine
{
	...
	public:
		Trampoline(const PxVec3& dimensions=PxVec3(1.f,1.f,1.f), PxReal stiffness=100.f, PxReal damping=1.0f)
		{
			PxReal thickness = .1f;
			bottom = new Box(PxTransform(PxVec3(0.f,thickness,0.f)),PxVec3(dimensions.x,thickness,dimensions.z), 10.0f);
...
//			px_scene->setSimulationEventCallback(my_callback);
			...
			box = new Box(PxTransform(PxVec3(.0f,10.0f,.0f)));
